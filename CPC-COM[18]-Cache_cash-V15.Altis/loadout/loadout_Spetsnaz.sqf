...
loadoutCC_M = //
{
	...
	if ((paramsArray select 3) == 1) then {_unit addPrimaryWeaponItem "rhs_acc_1pn93_1"; _unit additemtoBackpack "rhs_acc_pso1m2";} else {_unit addPrimaryWeaponItem "rhs_acc_pso1m2";};
