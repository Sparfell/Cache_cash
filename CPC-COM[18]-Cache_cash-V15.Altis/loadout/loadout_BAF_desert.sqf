...
loadoutCC_SL = //
{
	...
	_unit forceAddUniform "CUP_U_B_BAF_DDPM_Tshirt";
	...
	_unit addVest "CUP_V_BAF_Osprey_Mk2_DDPM_Officer";
	...
	if ((paramsArray select 3) == 1) then {_unit linkItem "CUP_NVG_HMNVS";_unit addPrimaryWeaponItem "CUP_acc_ANPEQ_2";};
...
loadoutCC_TL = //
{
	...
	_unit addHeadgear "CUP_H_BAF_Helmet_1_DDPM";
...
loadoutCC_DOC = //
{
	...
	_unit addVest "CUP_V_BAF_Osprey_Mk2_DDPM_Medic";
...
loadoutCC_MG = //
{
	...
	_unit addItemToUniform "CUP_15Rnd_9x19_M9";
	for "_i" from 1 to 2 do {_unit addItemToUniform "SmokeShell";};
	_unit addVest "CUP_V_BAF_Osprey_Mk2_DDPM_Empty";
...
loadoutCC_M = //
{
	...
	comment "Add containers";
	_unit forceAddUniform "CUP_U_B_BAF_DDPM_S2_UnRolled";
	for "_i" from 1 to 4 do {_unit addItemToUniform "ACE_fieldDressing";};
	_unit addItemToUniform "ACE_EarPlugs";
	_unit addItemToUniform "ACE_Flashlight_MX991";
	_unit addItemToUniform "ACE_tourniquet";
	...
	for "_i" from 1 to 14 do {_unit addItemToVest "CUP_5Rnd_86x70_L115A1";};
	_unit addHeadgear "CUP_H_BAF_Helmet_1_DDPM";

	comment "Add weapons";
	_unit addWeapon "CUP_srifle_AWM_des";
	if ((paramsArray select 3) == 0) then {_unit addPrimaryWeaponItem "CUP_optic_SB_3_12x50_PMII";} else {_unit addPrimaryWeaponItem "CUP_optic_AN_PVS_4"; _unit additemtovest "CUP_optic_SB_3_12x50_PMII";};
	...
	if ((paramsArray select 3) == 2) then {_unit linkItem "CUP_NVG_HMNVS";};
...
loadoutCC_DEMO = //
{
	...
	_unit addItemToUniform "CUP_15Rnd_9x19_M9";
	for "_i" from 1 to 2 do {_unit addItemToUniform "SmokeShell";};
	_unit addVest "CUP_V_BAF_Osprey_Mk2_DDPM_Sapper";
	for "_i" from 1 to 10 do {_unit addItemToVest "30Rnd_556x45_Stanag";};
	for "_i" from 1 to 2 do {_unit addItemToVest "CUP_HandGrenade_L109A1_HE";};
...
loadoutCC_GL = //
{
	...
	_unit addItemToUniform "CUP_15Rnd_9x19_M9";
	for "_i" from 1 to 2 do {_unit addItemToUniform "SmokeShell";};
	_unit addVest "CUP_V_BAF_Osprey_Mk2_DDPM_Grenadier";
...
loadoutCC_A = //
{
	...
	_unit addItemToUniform "CUP_15Rnd_9x19_M9";
	for "_i" from 1 to 2 do {_unit addItemToUniform "SmokeShell";};
	_unit addVest "CUP_V_BAF_Osprey_Mk2_DDPM_Scout";
	for "_i" from 1 to 10 do {_unit addItemToVest "30Rnd_556x45_Stanag";};
	for "_i" from 1 to 2 do {_unit addItemToVest "CUP_HandGrenade_L109A1_HE";};
...
loadoutCC_CREW = //
{
	...
	_unit addItemToUniform "CUP_15Rnd_9x19_M9";
	for "_i" from 1 to 2 do {_unit addItemToUniform "SmokeShell";};
	_unit addVest "CUP_V_BAF_Osprey_Mk2_DDPM_Crewman";
	for "_i" from 1 to 10 do {_unit addItemToVest "30Rnd_556x45_Stanag";};
	for "_i" from 1 to 2 do {_unit addItemToVest "CUP_HandGrenade_L109A1_HE";};
	_unit addHeadgear "CUP_H_BAF_Crew_Helmet_DDPM";
