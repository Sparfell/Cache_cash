...
loadoutCC_M = //
{
	...
	if ((paramsArray select 3) == 1) then {_unit addPrimaryWeaponItem "CUP_optic_SB_3_12x50_PMII";} else {_unit addPrimaryWeaponItem "CUP_optic_AN_PVS_4"; _unit additemtovest "CUP_optic_SB_3_12x50_PMII";};
