...
if (CPC_WorldType == "afrique") then {typeHouse = ["Land_Unfinished_Building_01_F","Land_Unfinished_Building_02_F","Land_MarketShelter_F","Land_Slum_House02_F","Land_Slum_House03_F","Land_Slum_House01_F","Land_cargo_house_slum_F","Land_u_House_Small_02_V1_F","Land_i_Stone_Shed_V1_F","Land_i_Stone_Shed_V2_F","Land_d_Stone_Shed_V1_F"];};
