...
if (CPC_WorldType == "chernarus") then {typeHouse = ["Land_i_Stone_HouseBig_V1_F","Land_i_Stone_Shed_V1_F","Land_i_Stone_HouseSmall_V1_F","Land_u_House_Small_02_V1_F","Land_u_House_Small_01_V1_F","Land_u_House_Big_02_V1_F"];};
