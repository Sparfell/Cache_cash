...
loadoutCC_M = //
{
	...
	if ((paramsArray select 3) == 0) then {_unit addPrimaryWeaponItem "CUP_optic_LeupoldMk4";} else {_unit addPrimaryWeaponItem "CUP_optic_AN_PVS_4"; _unit additemtouniform "CUP_optic_LeupoldMk4";};
