/*
	V17.1	16/02/2017
- Ajout d'une action pour confirmer le kill du chef ennemi (seul moyen de valider l'objectif)
- Modification du script HALO pour améliorer la fiabilité
- Fix pour chernarus et takistan (à tester)
- Ajout de deux véhicules (RG33L et Challenger II)
- quelques modifs sur des loadouts et des véhicules de factions IA
- ajout de CDF comme faction jouable
	V17		15/02/2017
- correction et réactivation de l'objectif "Tuer le chef"
- mise à jour de CPC_EXTRA
- diverses optimisations du code
- réorganisation des fichiers
- ajout de SAF comme faction jouable
- correction pour les scripts d'insertion en JIP
- retour des groupes en fortify dans les batiments grande zone
- amélioration du script HALO
- modification du script de meteo pour tenter de corriger les problèmes
de pluie
- Fix pour le loadout BAF
