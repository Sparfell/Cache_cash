...
hard_setLoadout = 
{
	...
	//OCP
	if (worldName in ["Altis","Tanoa","chernarus","Chernarus","IslaDuala3","Sara","FDF_Isle1_a","Woodland_ACR","pja305","pja307","noe","eden"]) then 
	{
...
loadoutCC_OFF = //
{
	...
	if (_ocp) then {_unit addVest "rhsusf_iotv_ocp_Teamleader";};
	if (_ucp) then {_unit addVest "rhsusf_iotv_ucp_Teamleader";};
...
loadoutCC_DOC = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_m67";};
	if (_ocp) then {_unit addVest "rhsusf_iotv_ocp_Medic";};
	if (_ucp) then {_unit addVest "rhsusf_iotv_ucp_Medic";};
...
loadoutCC_AR = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_an_m8hc";};
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_m67";};
	if (_ocp) then {_unit addVest "rhsusf_iotv_ocp_SAW";};
	if (_ucp) then {_unit addVest "rhsusf_iotv_ucp_SAW";};
...
loadoutCC_AAR = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_an_m8hc";};
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_m67";};
	if (_ocp) then {_unit addVest "rhsusf_iotv_ocp_Rifleman";};
	if (_ucp) then {_unit addVest "rhsusf_iotv_ucp_Rifleman";};
...
loadoutCC_MG = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_an_m8hc";};
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_m67";};
	if (_ocp) then {_unit addVest "rhsusf_iotv_ocp";};
	if (_ucp) then {_unit addVest "rhsusf_iotv_ucp";};
	if (_ocp) then {_unit addBackpack "rhsusf_assault_eagleaiii_ocp";};
	if (_ucp) then {_unit addBackpack "rhsusf_assault_eagleaiii_ucp";};
...
loadoutCC_DEMO = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_an_m8hc";};
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_m67";};
	if (_ocp) then {_unit addVest "rhsusf_iotv_ocp_Repair";};
	if (_ucp) then {_unit addVest "rhsusf_iotv_ucp_Repair";};
	for "_i" from 1 to 10 do {_unit addItemToVest "rhs_mag_30Rnd_556x45_Mk318_Stanag";};
	if (_ocp) then {_unit addBackpack "rhsusf_assault_eagleaiii_ocp";};
	if (_ucp) then {_unit addBackpack "rhsusf_assault_eagleaiii_ucp";};
...
loadoutCC_GL = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_an_m8hc";};
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_m67";};
	if (_ocp) then {_unit addVest "rhsusf_iotv_ocp_Grenadier";};
	if (_ucp) then {_unit addVest "rhsusf_iotv_ucp_Grenadier";};
	for "_i" from 1 to 10 do {_unit addItemToVest "rhs_mag_30Rnd_556x45_Mk318_Stanag";};
...
loadoutCC_CREW = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_an_m8hc";};
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_m67";};
	if (_ocp) then {_unit addVest "rhsusf_spcs_ocp_rifleman";};
	if (_ucp) then {_unit addVest "rhsusf_spcs_ucp_rifleman";};
	_unit addItemToVest "ACRE_PRC148";
...
loadoutCC_SNIPER = //
{
	...
	for "_i" from 1 to 2 do {_unit addItemToUniform "rhs_mag_an_m8hc";};
	if (_ocp) then {_unit addVest "rhsusf_spcs_ocp_rifleman";};
	if (_ucp) then {_unit addVest "rhsusf_spcs_ocp_rifleman";};
	...
	if (_ocp) then {_unit addHeadgear "rhs_Booniehat_ocp";_unit addGoggles "CUP_FR_NeckScarf2";};
	if (_ucp) then {_unit addHeadgear "rhs_Booniehat_ucp";_unit addGoggles "CUP_FR_NeckScarf2";};
